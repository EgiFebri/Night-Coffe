                ...
                <div class="card coffee-card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('login') }}">
                            ...
                            <button type="submit" class="btn btn-coffee w-100 text-white">Login</button>
                            <div class="text-center mt-3">
                                <a href="{{ route('register') }}" class="link-register">Don’t have an account? Register here</a>
                            </div>
                        </form>
                    </div>
                </div>
